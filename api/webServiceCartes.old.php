...
//$bdd = new PDO('mysql:host=bouscatel.isima.fr;dbname=bde', 'isidroid', '***REMOVED***', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));

try{
	$bdd = new PDO('mysql:host=localhost;dbname=bde', 'isidroid', '***REMOVED***'); // Appel => Localhost BDD => bde
}catch(Exception $e){
