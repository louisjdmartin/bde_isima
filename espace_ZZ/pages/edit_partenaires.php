<?php
	...
	$partenaires = api("get_liste_partenaires");
	echo "<button onclick='edit_partenaire(0)'>Ajouter un partenaire</button><table>";
	foreach($partenaires['liste'] as $p)
	{
		echo "
			<tr>
				...
				<td>".$p['nom']."</td>
				<td style='width:128px;text-align:center' ><button onclick='edit_partenaire(".$p['id'].")'>Editer</button></td>
			</tr>
		";
	}
	echo "</table>";
